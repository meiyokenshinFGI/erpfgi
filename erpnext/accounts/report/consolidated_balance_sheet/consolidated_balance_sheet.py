...
from erpnext.accounts.report.consolidated_financial_statements import (get_period_list, get_columns, get_data)

def execute(filters=None):
	period_list = get_period_list(filters.fiscal_year, filters.periodicity, from_beginning=True)

	asset = get_data(filters.consolidation, "Asset", "Debit", period_list)
	liability = get_data(filters.consolidation, "Liability", "Credit", period_list)
	equity = get_data(filters.consolidation, "Equity", "Credit", period_list)
