...
from erpnext.accounts.report.consolidated_accounts_receivable.consolidated_accounts_receivable import get_ageing_data
...
def get_conditions(filters, before_report_date=True):
	conditions = ""
	if filters.get("consolidation"):
		conditions += " and consolidation='%s'" % filters["consolidation"].replace("'", "\'")
